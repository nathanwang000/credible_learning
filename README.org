...
Code for paper [[https://arxiv.org/pdf/1711.03190.pdf][Learning Credible Models]]
...
Implementation of the EYE penalty can be find in [[lib/regularization.py]]. Our result on MIMIC2 dataset can be reproduced by running:
#+BEGIN_SRC bash
bash run.sh
#+END_SRC
